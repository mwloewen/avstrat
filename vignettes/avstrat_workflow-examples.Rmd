...
# Run this if you have a downloaded source file for the package:
install.packages("path/to/avstrat_0.0.0.9000.tar.gz", repos = NULL, type = "source")

# Run this if I've added you as a collaborator on GitHub and you have Git and GitHub setup on your system:
