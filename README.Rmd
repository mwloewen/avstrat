...
[![CRAN version](http://www.r-pkg.org/badges/version/avstrat)](https://cran.r-project.org/package=avstrat) [![](http://cranlogs.r-pkg.org/badges/avstrat)](https://cran.r-project.org/package=avstrat) [![](http://cranlogs.r-pkg.org/badges/grand-total/avstrat)](https://cran.r-project.org/package=avstrat) [![pipeline status](https://code.usgs.gov/mloewen/demo_package/badges/main/pipeline.svg)](https://code.usgs.gov/mloewen/demo_package/-/commits/main) [![coverage report](https://code.usgs.gov/mloewen/demo_package/badges/main/coverage.svg)](https://code.usgs.gov/mloewen/demo_package/-/commits/main)
