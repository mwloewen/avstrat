...
[![Codecov test coverage](https://codecov.io/gh/mwloewen/avstrat/graph/badge.svg)](https://app.codecov.io/gh/mwloewen/avstrat)
...
Once you have the data in your environment, you can make a basic stratigraphic plot:

```{r example_basic_grainsize_plot}
library(avstrat)
library(readxl)
# Load data
...
```{r example_reverse_grainsize_plot}
...
```{r example_combined_sample_plot}
library(patchwork)
