...
```{r example_basic_grainsize_plot, fig.width=2.5, fig.height=5}
library(ggplot2)
library(readxl)
library(avstrat)
# Load data
...
```{r example_reverse_grainsize_plot, fig.width=2.5, fig.height=5}
...
```{r example_combined_sample_plot, fig.width=5, fig.height=6}
library(patchwork)
...
More examples and demonstration of how to create your own custom plots will be provided [eventually] in vignettes!
